(function () {
...
})()(
  {
    ...
    4: [
      function (require, module, exports) {
        ...
        var Mat3 = /*#__PURE__*/ (function () {
            ...
            do {
              ...
              do {
                ...
                do {
                  p = nc - np;
                  eqns[p + nc * j] =
                    eqns[p + nc * j] - eqns[p + nc * i] * _multiplier;
                } while (--np);
              } while (j--);
          ...
          _proto.setRotationFromQuaternion = function setRotationFromQuaternion(
            q
          ) {
            var x = q.x;
            var y = q.y;
        ...
        var Vec3 = /*#__PURE__*/ (function () {
          ...
          _proto.addScaledVector = function addScaledVector(
            scalar,
            vector,
            target
          ) {
          ...
          _proto.isAntiparallelTo = function isAntiparallelTo(
            vector,
            precision
          ) {
        ...
        var AABB = /*#__PURE__*/ (function () {
          ...
          _proto.setFromPoints = function setFromPoints(
            points,
            position,
            quaternion,
            skinSize
        ...
        var Quaternion = /*#__PURE__*/ (function () {
          ...
          _proto.setFromVectors = function setFromVectors(u, v) {
            if (u.isAntiparallelTo(v)) {
              ...
              this.z = a.z;
              this.w =
                Math.sqrt(Math.pow(u.length(), 2) * Math.pow(v.length(), 2)) +
                u.dot(v);
              this.normalize();
            }
          ...
          _proto.integrate = function integrate(
            angularVelocity,
            dt,
            angularFactor,
            target
        ...
        var Shape = /*#__PURE__*/ (function () {
          ...
          _proto.updateBoundingSphereRadius =
            function updateBoundingSphereRadius() {
              throw (
          ...
          _proto.calculateLocalInertia = function calculateLocalInertia(
            mass,
            target
          ) {
            throw (
          ...
          _proto.calculateWorldAABB = function calculateWorldAABB(
            pos,
            quat,
            min,
            max
        ...
        var Transform = /*#__PURE__*/ (function () {
          ...
          _proto.vectorToWorldFrame = function vectorToWorldFrame(
            localVector,
            result
          ) {
            if (result === void 0) {
          ...
          Transform.pointToLocalFrame = function pointToLocalFrame(
            position,
            quaternion,
            worldPoint,
            result
          ...
          Transform.pointToWorldFrame = function pointToWorldFrame(
            position,
            quaternion,
            localPoint,
            result
          ...
          Transform.vectorToWorldFrame = function vectorToWorldFrame(
            quaternion,
            localVector,
            result
          ) {
          ...
          Transform.vectorToLocalFrame = function vectorToLocalFrame(
            position,
            quaternion,
            worldVector,
            result
        ...
        var ConvexPolyhedron = /*#__PURE__*/ (function (_Shape) {
          ...
          _proto.clipAgainstHull = function clipAgainstHull(
            posA,
            quatA,
            hullB,
            posB,
          ...
          _proto.findSeparatingAxis = function findSeparatingAxis(
            hullB,
            posA,
            quatA,
            posB,
          ...
          _proto.testSepAxis = function testSepAxis(
            axis,
            hullB,
            posA,
            quatA,
          ...
          _proto.getPlaneConstantOfFace = function getPlaneConstantOfFace(
            face_i
          ) {
          ...
          _proto.clipFaceAgainstHull = function clipFaceAgainstHull(
            separatingNormal,
            posA,
            quatA,
            worldVertsB1,
          ...
          _proto.clipFaceAgainstPlane = function clipFaceAgainstPlane(
            inVertices,
            outVertices,
            planeNormal,
            planeConstant
          ...
          _proto.computeWorldVertices = function computeWorldVertices(
            position,
            quat
          ) {
          ...
          _proto.computeLocalAABB = function computeLocalAABB(
            aabbmin,
            aabbmax
          ) {
            var vertices = this.vertices;
          ...
          _proto.computeWorldFaceNormals = function computeWorldFaceNormals(
            quat
          ) {
          ...
          _proto.transformAllPoints = function transformAllPoints(
            offset,
            quat
          ) {
        ...
        var Box = /*#__PURE__*/ (function (_Shape) {
          ...
          _proto.updateConvexPolyhedronRepresentation =
            function updateConvexPolyhedronRepresentation() {
          ...
          _proto.getSideNormals = function getSideNormals(
            sixTargetVectors,
            quat
          ) {
          ...
          _proto.forEachWorldCorner = function forEachWorldCorner(
            pos,
            quat,
            callback
          ) {
        ...
        var Body = /*#__PURE__*/ (function (_EventTarget) {
          ...
          _proto.updateSolveMassProperties =
            function updateSolveMassProperties() {
              if (
                this.sleepState === Body.SLEEPING ||
          ...
          _proto.pointToLocalFrame = function pointToLocalFrame(
            worldPoint,
            result
          ) {
            if (result === void 0) {
          ...
          _proto.vectorToLocalFrame = function vectorToLocalFrame(
            worldVector,
            result
          ) {
            if (result === void 0) {
          ...
          _proto.pointToWorldFrame = function pointToWorldFrame(
            localPoint,
            result
          ) {
            if (result === void 0) {
          ...
          _proto.applyLocalForce = function applyLocalForce(
            localForce,
            localPoint
          ) {
            if (this.type !== Body.DYNAMIC) {
     ...
     */
          ...
          _proto.applyLocalImpulse = function applyLocalImpulse(
            localImpulse,
            localPoint
          ) {
            if (this.type !== Body.DYNAMIC) {
          ...
          _proto.getVelocityAtWorldPoint = function getVelocityAtWorldPoint(
            worldPoint,
            result
          ) {
            var r = new Vec3();
        ...
        var Broadphase = /*#__PURE__*/ (function () {
          ...
          _proto.needBroadphaseCollision = function needBroadphaseCollision(
            bodyA,
            bodyB
          ) {
          ...
          _proto.intersectionTest = function intersectionTest(
            bodyA,
            bodyB,
            pairs1,
            pairs2
          ...
          _proto.doBoundingSphereBroadphase =
            function doBoundingSphereBroadphase(bodyA, bodyB, pairs1, pairs2) {
          ...
          _proto.doBoundingBoxBroadphase = function doBoundingBoxBroadphase(
            bodyA,
            bodyB,
            pairs1,
            pairs2
        ...
        var GridBroadphase = /*#__PURE__*/ (function (_Broadphase) {
          ...
          _proto.collisionPairs = function collisionPairs(
            world,
            pairs1,
            pairs2
          ) {
        ...
        var Ray = /*#__PURE__*/ (function () {
          ...
          _proto.intersectShape = function intersectShape(
            shape,
            quat,
            position,
            body
          ...
          _proto._intersectBox = function _intersectBox(
            box,
            quat,
            position,
            body,
          ...
          _proto._intersectPlane = function _intersectPlane(
            shape,
            quat,
            position,
            body,
          ...
          _proto._intersectHeightfield = function _intersectHeightfield(
            shape,
            quat,
            position,
            body,
          ...
          _proto._intersectSphere = function _intersectSphere(
            sphere,
            quat,
            position,
            body,
          ...
          _proto._intersectConvex = function _intersectConvex(
            shape,
            quat,
            position,
            body,
          ...
          _proto._intersectTrimesh = function _intersectTrimesh(
            mesh,
            quat,
            position,
            body,
          ...
          _proto.reportIntersection = function reportIntersection(
            normal,
            hitPointWorld,
            shape,
            body,
        ...
        var JacobianElement = /*#__PURE__*/ (function () {
          ...
          _proto.multiplyVectors = function multiplyVectors(
            spatial,
            rotational
          ) {
        ...
        var Equation = /*#__PURE__*/ (function () {
          ...
          _proto.setSpookParams = function setSpookParams(
            stiffness,
            relaxation,
            timeStep
          ) {
        ...
        var ContactEquation = /*#__PURE__*/ (function (_Equation) {
          ...
          _proto.getImpactVelocityAlongNormal =
            function getImpactVelocityAlongNormal() {
        ...
        var ConeEquation = /*#__PURE__*/ (function (_Equation) {
          ...
          function ConeEquation(bodyA, bodyB, options) {
            ...
            _this =
              _Equation.call(this, bodyA, bodyB, -maxForce, maxForce) || this;
         ...
         */
        var ConeTwistConstraint = /*#__PURE__*/ (function (
          _PointToPointConstrai
        ) {
          ...
          function ConeTwistConstraint(bodyA, bodyB, options) {
            ...
            var t = (_this.twistEquation = new RotationalEquation(
              bodyA,
              bodyB,
              options
            ));
          ...
          function LockConstraint(bodyA, bodyB, options) {
            ...
            _this =
              _PointToPointConstrai.call(
                ...
                pivotB,
                maxForce
              ) || this; // Store initial rotation of the bodies as unit vectors in the local body spaces
            ...
            var r2 = (_this.rotationalEquation2 = new RotationalEquation(
              bodyA,
              bodyB,
              options
            ));
            var r3 = (_this.rotationalEquation3 = new RotationalEquation(
              bodyA,
              bodyB,
              options
            ));
        ...
        var HingeConstraint = /*#__PURE__*/ (function (_PointToPointConstrai) {
          ...
          function HingeConstraint(bodyA, bodyB, options) {
            ...
            var axisA = (_this.axisA = options.axisA
              ? options.axisA.clone()
              : new Vec3(1, 0, 0));
            axisA.normalize();
            var axisB = (_this.axisB = options.axisB
              ? options.axisB.clone()
              : new Vec3(1, 0, 0));
            axisB.normalize();
            _this.collideConnected = !!options.collideConnected;
            ...
            var rotational2 = (_this.rotationalEquation2 =
              new RotationalEquation(bodyA, bodyB, options));
            var motor = (_this.motorEquation = new RotationalMotorEquation(
              bodyA,
              bodyB,
              maxForce
            ));
        ...
        var FrictionEquation = /*#__PURE__*/ (function (_Equation) {
          ...
          function FrictionEquation(bodyA, bodyB, slipForce) {
            ...
            _this =
              _Equation.call(this, bodyA, bodyB, -slipForce, slipForce) || this;
            _this.ri = new Vec3();
            _this.rj = new Vec3();
            _this.t = new Vec3();
            return _this;
        ...
        var RaycastVehicle = /*#__PURE__*/ (function () {
          ...
          _proto.setSteeringValue = function setSteeringValue(
            value,
            wheelIndex
          ) {
          ...
          _proto.applyEngineForce = function applyEngineForce(
            value,
            wheelIndex
          ) {
          ...
          _proto.getVehicleAxisWorld = function getVehicleAxisWorld(
            axisIndex,
            result
          ) {
            result.set(
          ...
          _proto.updateWheelTransformWorld = function updateWheelTransformWorld(
            wheel
          ) {
          ...
          _proto.updateWheelTransform = function updateWheelTransform(
            wheelIndex
          ) {
            var up = tmpVec4;
            var right = tmpVec5;
          ...
          _proto.getWheelTransformWorld = function getWheelTransformWorld(
            wheelIndex
          ) {
          ...
          _proto.updateFriction = function updateFriction(timeStep) {
            ...
            for (var _i5 = 0; _i5 < numWheels; _i5++) {
              ...
              if (_groundObject2) {
                _wheel3.skidInfo = 1;
                var maximp =
                  _wheel3.suspensionForce * timeStep * _wheel3.frictionSlip;
          ...
          _proto.update = function update() {
            ...
            for (var _i = 0; _i !== N; _i++) {
              ...
              for (var _j = 0; _j !== _numNeighbors; _j++) {
                ...
                u.scale(
                  (1.0 / (0.0001 + this.densities[_i] * this.densities[_j])) *
                    this.viscosity *
                    neighbor.mass,
                  u
                );
        ...
        var Heightfield = /*#__PURE__*/ (function (_Shape) {
          ...
          _proto.setHeightValueAtIndex = function setHeightValueAtIndex(
            xi,
            yi,
            value
          ) {
          ...
          _proto.getRectMinMax = function getRectMinMax(
            iMinX,
            iMinY,
            iMaxX,
            iMaxY,
          ...
          _proto.getIndexOfPosition = function getIndexOfPosition(
            x,
            y,
            result,
            clamp
          ...
          _proto.getTriangleAt = function getTriangleAt(
            x,
            y,
            edgeClamp,
            a,
          ...
          _proto.getCacheConvexTrianglePillarKey =
            function getCacheConvexTrianglePillarKey(xi, yi, getUpperTriangle) {
              return xi + '_' + yi + '_' + (getUpperTriangle ? 1 : 0);
            };

          _proto.getCachedConvexTrianglePillar =
            function getCachedConvexTrianglePillar(xi, yi, getUpperTriangle) {
              return this._cachedPillars[
                this.getCacheConvexTrianglePillarKey(xi, yi, getUpperTriangle)
              ];
            };

          _proto.setCachedConvexTrianglePillar =
            function setCachedConvexTrianglePillar(
              xi,
              yi,
              getUpperTriangle,
              convex,
          ...
          _proto.clearCachedConvexTrianglePillar =
            function clearCachedConvexTrianglePillar(xi, yi, getUpperTriangle) {
          ...
          _proto.getConvexTrianglePillar = function getConvexTrianglePillar(
            xi,
            yi,
            getUpperTriangle
          ) {
          ...
          _proto.setHeightsFromImage = function setHeightsFromImage(
            image,
            scale
          ) {
            var x = scale.x,
        ...
        var Trimesh = /*#__PURE__*/ (function (_Shape) {
          ...
          _proto.getTrianglesInAABB = function getTrianglesInAABB(
            aabb,
            result
          ) {
          ...
          _proto.getEdgeVertex = function getEdgeVertex(
            edgeIndex,
            firstOrSecond,
            vertexStore
          ) {
          ...
          _proto.getEdgeVector = function getEdgeVector(
            edgeIndex,
            vectorStore
          ) {
          ...
          _proto.getTriangleVertices = function getTriangleVertices(
            i,
            a,
            b,
            c
        ...
        */
        ...
        var Narrowphase = /*#__PURE__*/ (function () {
          ...
          _proto.createContactEquation = function createContactEquation(
            bi,
            bj,
            si,
            sj,
          ...
          _proto.createFrictionEquationsFromContact =
          ...
          _proto.createFrictionFromAverage = function createFrictionFromAverage(
            numContacts
          ) {
          ...
          _proto.sphereSphere = function sphereSphere(
            si,
            sj,
            xi,
            xj,
          ...
          _proto.spherePlane = function spherePlane(
            si,
            sj,
            xi,
            xj,
          ...
          _proto.sphereBox = function sphereBox(
            si,
            sj,
            xi,
            xj,
          ...
          _proto.planeBox = function planeBox(
            si,
            sj,
            xi,
            xj,
          ...
          _proto.convexConvex = function convexConvex(
            si,
            sj,
            xi,
            xj,
          ...
          _proto.sphereConvex = function sphereConvex(
            si,
            sj,
            xi,
            xj,
          ...
          _proto.planeConvex = function planeConvex(
            planeShape,
            convexShape,
            planePosition,
            convexPosition,
          ...
          _proto.boxConvex = function boxConvex(
            si,
            sj,
            xi,
            xj,
          ...
          _proto.sphereHeightfield = function sphereHeightfield(
            sphereShape,
            hfShape,
            spherePos,
            hfPos,
        ...
        */
          ...
          _proto.boxHeightfield = function boxHeightfield(
            si,
            sj,
            xi,
            xj,
          ...
          _proto.convexHeightfield = function convexHeightfield(
            convexShape,
            hfShape,
            convexPos,
            hfPos,
          ...
          _proto.sphereParticle = function sphereParticle(
            sj,
            si,
            xj,
            xi,
          ...
          _proto.planeParticle = function planeParticle(
            sj,
            si,
            xj,
            xi,
          ...
          _proto.boxParticle = function boxParticle(
            si,
            sj,
            xi,
            xj,
          ...
          _proto.convexParticle = function convexParticle(
            sj,
            si,
            xj,
            xi,
          ...
          _proto.sphereTrimesh = function sphereTrimesh(
            sphereShape,
            trimeshShape,
            spherePos,
            trimeshPos,
            ...
            for (var _i2 = 0; _i2 < triangles.length; _i2++) {
              for (var _j6 = 0; _j6 < 3; _j6++) {
                trimeshShape.getVertex(
                  trimeshShape.indices[triangles[_i2] * 3 + _j6],
                  edgeVertexA
                );
                trimeshShape.getVertex(
                  trimeshShape.indices[triangles[_i2] * 3 + ((_j6 + 1) % 3)],
                  edgeVertexB
                );
          ...
          _proto.planeTrimesh = function planeTrimesh(
            planeShape,
            trimeshShape,
            planePos,
            trimeshPos,
        ...
        Narrowphase.prototype[COLLISION_TYPES.spherePlane] =
          Narrowphase.prototype.spherePlane; // See http://bulletphysics.com/Bullet/BulletFull/SphereTriangleDetector_8cpp_source.html
        ...
        Narrowphase.prototype[COLLISION_TYPES.convexConvex] =
          Narrowphase.prototype.convexConvex; // Narrowphase.prototype[COLLISION_TYPES.convexTrimesh] = Narrowphase.prototype.convexTrimesh
        ...
        Narrowphase.prototype[COLLISION_TYPES.sphereParticle] =
          Narrowphase.prototype.sphereParticle; // WIP
        ...
        var World = /*#__PURE__*/ (function (_EventTarget) {
          ...
          _proto.raycastClosest = function raycastClosest(
            from,
            to,
            options,
            result
    ...
    5: [
      function (require, module, exports) {
        ...
        exports.createHeightfieldTerrainShape = function (root, options) {
          ...
          const scale = new Ammo.btVector3(
            heightfieldDistance,
            1,
            heightfieldDistance
          );
